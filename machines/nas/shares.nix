  ...
  firewall.rules = dag: with dag; {
    inet.filter.input = {
      nfs = between [ "established" ] [ "drop" ] [
        ''ip saddr 172.23.200.128/25 tcp dport 2049 accept''
        ''ip saddr 172.23.200.128/25 udp dport 2049 accept''
      ...
      smb = between [ "established" ] [ "drop" ] [
        ''ip saddr 172.23.200.128/25 tcp dport { 137, 138, 139, 445 } accept''
        ''ip saddr 172.23.200.128/25 udp dport { 137, 138, 139, 445 } accept''
